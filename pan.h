...
#define _nstates2	32	/* :init: */
#define minseq2	66
#define maxseq2	96
#define _endstate2	31

#define _nstates1	46	/* receiver */
#define minseq1	21
#define maxseq1	65
#define _endstate1	45

#define _nstates0	22	/* proc */
#define minseq0	0
#define maxseq0	20
...
#define Air2	(sizeof(P2) - Offsetof(P2, CtoR) - 1*sizeof(uchar))
...
#define Air1	(sizeof(P1) - Offsetof(P1, from_C) - 1*sizeof(uchar))

#define Pproc	((P0 *)_this)
typedef struct P0 { /* proc */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, to_receiver) - 1*sizeof(uchar))
